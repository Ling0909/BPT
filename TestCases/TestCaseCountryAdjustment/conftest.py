...
from PageObjects.page_CountryAdjustment import PageCountryAdjustment
...
def for_policyList_class():
    ...
    pl=PageLogin(driver)
    pi=PageIndex(driver)
    pca=PageCountryAdjustment(driver)
    ...
    pca.download_policyList_CountryAdjustment(dpl.datas_CountryAdjustment['policyType'])
    yield(pca,ppp)
    driver.quit()
