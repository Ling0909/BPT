...
from PageObjects.page_nonBMCUplift import PageNonBMCUplift
...
def for_policyList_class():
    ...
    pnbu.download_policyList_CountryAdjustment(dpl.datas_nonBMCUplift['policyType'])
    yield(pnbu,ppp)
    driver.quit()
