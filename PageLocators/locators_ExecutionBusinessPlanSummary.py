...
class LocatorsExecutionBusinessPlanv:
    # 创建business plan
    ...
    ele_iframe_export1 = (By.XPATH, '//iframe[contains(@name,"OpenartDialog16140728785381")]')
    input_File_Upload = (By.ID, 'ContentPlaceHolder2_fpUpload')
    upload_button_tankuang = (By.XPATH, '//a[@id="ContentPlaceHolder2_btnUpload"]')