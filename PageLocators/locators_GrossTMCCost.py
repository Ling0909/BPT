...
class LocatorsGrossTMCCost:
    ...
    # 定位Gross BMC Cost ($)字段各月份值
    eles_Gross_BMC_Cost_Month= (By.XPATH, '//span[text()="Gross BMC Cost ($)"]/../..//input/../../../div[@class="col-xs-2"]//input')
    ...
    ele_avg_Gross_TMC_Cost=(By.XPATH, '//span[text()="Gross TMC Cost ($)"]/../..//input')
    eles_Gross_TMC_Cost_Month = (By.XPATH,'//span[text()="Gross TMC Cost ($)"]/../..//input/../../../div[@class="col-xs-2"]//input')  # 定位BMC Cost w/ Fundings($)字段各月份值
